...
return [
    'modules' => [
        ...
        'RLTSquare_AjaxAddToCartPopup' => 1,
        'RLTSquare_GetCollectionUnder10' => 1,
        'RLTSquare_ProductCustomAttribute' => 1,
        'RLTSquare_UpdateAddtocartSuccessMsg' => 1,
        'RLTSquare_UpdatePrice' => 1,
